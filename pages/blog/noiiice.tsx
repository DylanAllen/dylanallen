...
const Noiiice: React.FunctionComponent<{ state: any}>  = () => {
  ...
  return (
    <Layout title={`${meta.title} | Dylan Allen | JavaScript Developer | Frontend Web`}>
      ...
      <p>
        For the past several months I have been working on a blog CMS, and it is finally ready to use! I have a few more features that I wan to add before I give it to 1.0 distinction, but it is available on <a href="https://github.com/DylanAllen/noiiice">Github</a> to clone and deploy. You can see the demo site here: <a href="https://noiiice.com/">Noiiice.com</a>.  
      </p>
      <p>
      ...
      <h2>Features</h2>
      <ul>
        <li>Authentication system/account creation in app (using AWS Cognito)</li>
        <li>Admin UI to create/manage posts, and manage comments</li>
        <li>Automated emails when comments created</li>
        <li>Server side rendering on blog, posts, and pages (posts stored in DynamoDb table and dynamically rendered, pages coded in Nuxt framework)</li>
        <li>A few base themes, and a SCSS based theming system with light/dark mode detection</li>
        <li>Google Analytics integration</li>
        <li>Media manager (image upload, browse images, and copy url/img tag)</li>
