  ...
  return (
    <Layout title={`${meta.title} | Dylan Allen | JavaScript Developer | Frontend Web`} image={meta.image} description={meta.description}>
      <div className="container">
        ...
        If you just want to see the code, you can peruse the <a href="https://codesandbox.io/s/react-toast-component-8w9wz?file=/src/App.js:524-622">Code Sandbox</a>.
        </p>
        <p>
          If you don't know what I mean when I say "toast notification", <a onClick={() => toast('This is a toast!')}>click here</a> to see an example. 
          It is a message that pops up at the bottom of the window like toast popping out of the toaster.
        </p>
        ...
        <h2>Style: CSS</h2>
        <p>
          There isn't a whole lot to the CSS. 
          A simple transform rule gives us the pop up and drop down motion when the className is toggled.
        </p>
        <pre>
        ...
        <p>
          This is the kind of component you need to be able to access from several different components. So it makes sense to pass the toast function to a Context provider at the root level.
          I wanted it to be as easy as possible to create a toast notification, so I created a function that handles the state updates, and then I pass that function to the context.
        </p>
        <pre>
          <code className="language-javascript">
            {codeImplement}
        ...
        <p>
          If you need a feature rich component, then you will probably want to use an existing library like <a href="https://github.com/fkhadra/react-toastify">React Toastify</a>. 
          But if you want to add a simple solution to your app without importing extra dependencies, this will do the trick. This is basically what I am using on this site, but my site is in TypeScript, 
          so if you need a TS example, you can look through the code on my <a href="https://github.com/DylanAllen/dylanallen/blob/master/components/Toast.tsx">GitHub repo</a>.
        </p>
        <p>You can see a working demo in this <a href="https://codesandbox.io/s/react-toast-component-8w9wz?file=/src/App.js:524-622">Code Sandbox</a></p>
...
export const meta = {
  ...
  description: 'I love toast notifications. Simple, unobtrusive, and useful. In this post I am going to show you how to create a simple toast component and implement it with React Hooks.',
  image:  '/toast.jpg',
  slug: 'toast',
